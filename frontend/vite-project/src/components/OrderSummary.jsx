...
const stripePromise = loadStripe(
	"pk_test_51QNGHSFA3LCDh5tCDYse7F1VClDpAEFiy4tauq3dLJ7hepY5x48LBozrjia4BVULQAPJ3cRiU98p45DTQu10w4aE00Bh7ntS2J"
);
...
const OrderSummary = () => {
    ...
    const [error] = useState(""); // Để kiểm tra lỗi nếu thiếu thông tin
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border border-gray-500 bg-white-800 p-4 shadow-sm sm:p-6'
			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					<dl className='flex items-center justify-between gap-4'>
						...
						<dd className='text-base font-medium text-gray-300'>${formattedSubtotal}</dd>
					</dl>
                ...
                <div className="space-y-4">
	              <p className="text-lg font-semibold text-black">Shipping Address</p>
	            <input
		          type="text"
	          ...
	          />
				...
				<motion.button
					className='flex w-full items-center justify-center rounded-lg bg-black px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-500 focus:outline-none focus:ring-4 focus:ring-gray-500'
